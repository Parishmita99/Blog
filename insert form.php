...
<body>
    ...
    <div class="container" align="center">
     <form accept="" method="POST" enctype="multipart/form-data" class="formcontainer">
    <div class="row">
      <div class="col-25">
        <label for="TITLE">TITLE:</label>
      </div>
      <div class="col-75">
        <input type="text" name="title" id="TITLE" placeholder="Title of the article....">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" name="author" id="Name" placeholder="Author's Name....">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
